                ...
                <div class="row">
                    ...
                    <div class="col-7 align-self-center">
                        <div class="d-flex no-block justify-content-end align-items-center">
                             <button type="button" class="btn btn-success" onclick="addModalBtn()"><i class="fa fa-plus-circle"></i> Add Staff</button>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <form  id="updateForm" enctype="multipart/form-data">
                                <div class="modal-body">
                                    @csrf
                                        <div class="form-group">
                                            <label for="staff_roll" class="control-label">Staff Roll</label>
                                            <input type="text" class="form-control" id="edit_staff_roll" name="staff_roll" required="true">
                                        </div>
                                        <div class="form-group">
                                            <label for="fname" class="control-label">First Name</label>
                                        ...
                                        <div class="form-group">
                                            <label for="designation" class="control-label">Designation</label>
                                            <select class="custom-select mr-sm-2" id="edit_designation" name="designation" required="true">
                                                <option value="" selected>Choose...</option>
                                                <option value="Head Of Department"> Head Of Department</option>
                                                <option value="Professor"> Professor</option>
                                                <option value="Assistant Professor"> Assistant Professor</option>
                                        ...
                                        <div class="form-group">
                                            <label for="phone_number" class="control-label">Phone Number</label>
                                            <input type="text" class="form-control" id="edit_phone_number" name="phone_number" required="true">
                                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#table').DataTable( {
                ...
                "serverSide": true,
                "ajax":{
                         "url": "{{ route('admin.staffs.getData') }}",
                         "dataType": "json",
                         "type": "POST",
                    ...
                    {   
                        ...
                        if(data.length === 1){
                            $.each(data,function(key,value){
                               ...
                               $('#edit_staff_roll').val(value.staff_roll);
