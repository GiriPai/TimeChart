                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Master Data</h4>
                                    <form  id="addForm" enctype="multipart/form-data" method="post" action="{{route('admin.ds.update')}}">
                                    ...
                                    @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" id="class_name" name="class_name" required="true">
                                                <option value="{{ $record->class_name }}" selected>{{ $record->class_name }}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2 sessions" id="s1" name="s1" required="true">
                                                <option value="{{$record->s1}}" selected>{{ $record->session1->subject_name }}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2 sessions" id="s2" name="s2" required="true">
                                                <option value="{{$record->s2}}" selected>{{ $record->session2->subject_name }}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2 sessions" id="s3" name="s3" required="true">
                                                <option value="{{$record->s3}}" selected>{{ $record->session3->subject_name }}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2 sessions" id="s4" name="s4" required="true">
                                                <option value="{{$record->s4}}" selected>{{ $record->session4->subject_name }}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2 sessions" id="s5" name="s5" required="true">
                                                <option value="{{$record->s5}}" selected>{{ $record->session5->subject_name }}</option>
