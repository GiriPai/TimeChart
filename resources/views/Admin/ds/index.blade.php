                ...
                <div class="row">
                    ...
                    <div class="col-7 align-self-center">
                        <div class="d-flex no-block justify-content-end align-items-center">
                             <button type="button" class="btn btn-success" ><i class="fa fa-plus-circle"></i><a href="{{ route('admin.ds.insert') }}"> Add New Data </a></button>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <table id="file_export" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                    <a href="{{ route('admin.ds.edit',$chart->id) }}"><button type="button" class="btn btn-info waves-effect waves-light"> Edit</button></a>
                                                    <a href="{{ route('admin.ds.delete',$chart->id) }}"><button type="button" class="btn btn-danger waves-effect waves-light"> Delete</button></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                            @else
