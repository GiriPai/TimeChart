                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Subject</h4>
                                    <form  id="addForm" enctype="multipart/form-data" method="post" action="{{route('admin.subjects.update')}}">
                                <div class="modal-body">
                                    @csrf
                                        <div class="form-group">
                                            <label for="subject_no" class="control-label">Subject No</label>
                                            <input type="text" class="form-control" id="subject_no" name="subject_no"  value="{{ $subject->subject_no}}" required="true">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" id="staff_id" name="staff_id" required="true" value="{{ $subject->staff_id}}">
