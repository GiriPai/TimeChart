            ...
            <div class="row">
               ...
               <!--  <div class="col-7 align-self-center">
                    <div class="d-flex no-block justify-content-end align-items-center">
                         <button type="button" class="btn btn-success" onclick="addModalBtn()"><i class="fa fa-plus-circle"></i> </button>
                    </div>
                </div> -->
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Book Halls</h4>
                           
                            <form  id="addForm" enctype="multipart/form-data" method="post" action="{{ route('staff.hall.store') }}">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" id="hall_name" name="hall_name" required="true">
                                            <option value="" selected>Choose...</option>
                                            
                                            <option value="Sri Krishna Hall"> Sri Krishna Hall </option>
