                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('staff.student.index', $details->course ) }}">Students</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <center class="m-t-30"> <img src="{{asset($details->profpic_url)}}" class="rounded-circle" width="150" />
                            ...
                            <h6 class="card-subtitle">{{ $details->student_roll }}</h6>
                            <div class="row text-center justify-content-md-center">
                                <h5 class="card-subtitle">{{ $details->course }}</h6>
                            </div>
                        </center>
                    </div>
                    <div>
                    ...
                    <div class="card-body"> <small class="text-muted">Email address </small>
                        ...
                        <h6>{{ $details->phone_number }}</h6> <small class="text-muted p-t-30 db">Address</small>
